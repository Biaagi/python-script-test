...
DELAY_BETWEEN_TRADE = (5, 15)  # Execute delay between every trade (Buy -> Delay -> Sell -> Buy -> Delay ...)
...
TRADE_AMOUNT = [20, 20]  # (works nearly from +-20%), minimum (5$) and maximum amount to trade in USD, if 0 it will trade on FULL balance
